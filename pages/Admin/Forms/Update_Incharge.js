...
export default function UpdateStaff({ onClose, incharge }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.error || 'Failed to update incharge');
            }

            Swal.fire({
                icon: 'success',
                title: 'Staff Updated',
                text: 'The Incharge has been successfully updated.',
