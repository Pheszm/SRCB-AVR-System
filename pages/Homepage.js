                    ...
                    <div className="container">
                        <div className="row gy-4">
                            <div className="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                                ...
                                <p>Simplifying the Reservation and Inventory<br/> Management of the Audio Visual Room</p>
                        ...
                        <div className="row gy-4">
                            ...
                            <div className="col-lg-6">
                                <div className="team-member d-flex align-items-start">
                                    ...
                                    <div className="member-info">
                                        <h4>Domenic Daguit</h4>
                                        <span>Designer</span>
                                        <p>
                                        A creative designer dedicated to crafting visually compelling and user-centered designs that elevate brands and engage audiences.
                                        </p>
                                        <div className="social">
                                            <a href="" target="_blank">
                                                <i className="bi bi-github" />
